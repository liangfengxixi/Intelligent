...
public class NiceSpinner extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setPadding(resources.getDimensionPixelSize(R.dimen.three_grid_unit), 0, defaultPadding,
                0);
        setClickable(true);
...
//        textSize =
//                typedArray.getDimensionPixelSize(R.styleable.NiceSpinner_textSize, 13);
//        setTextSize(textSize);
    ...
    public <T> void attachDataSource(@NonNull List<T> list) {
        adapter = new NiceSpinnerAdapter<>(getContext(), list, textColor,textSize, backgroundSelector, spinnerTextFormatter, horizontalAlignment);
        setAdapterInternal(adapter);
    }

    public void setAdapter(ListAdapter adapter) {
        this.adapter = new NiceSpinnerAdapterWrapper(getContext(), adapter, textColor,textSize, backgroundSelector,
