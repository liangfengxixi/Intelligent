...
import kotlinx.android.synthetic.main.fragment_panel_1.*


/**
 * 生产看板
 */
class Panel1Fragment : BaseSupportFragment() {

    val url = "http://106.13.160.198"

    override fun getContentRes(): Int {
        return R.layout.fragment_panel_1
    }

    companion object {
        fun newInstance(): Panel1Fragment {
            return Panel1Fragment()
        }
    }
